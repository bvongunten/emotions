...
public class TeamResourceIT {
    ...
    public void createTeam() throws Exception {
        ...
        assertThat(testTeam.getRegion()).isEqualTo(DEFAULT_REGION);
    ...
    @Test
    @Transactional
    public void checkSloganIsRequired() throws Exception {
        int databaseSizeBeforeTest = teamRepository.findAll().size();
        // set the field null
        team.setSlogan(null);
    ...
    public void updateTeam() throws Exception {
        ...
        assertThat(testTeam.getRegion()).isEqualTo(UPDATED_REGION);
