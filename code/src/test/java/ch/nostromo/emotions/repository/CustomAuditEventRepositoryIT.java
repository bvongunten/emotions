...
import ch.nostromo.emotions.config.audit.AuditEventConverter;
import ch.nostromo.emotions.domain.PersistentAuditEvent;
...
import static ch.nostromo.emotions.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
